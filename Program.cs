using System;
using PrototypeUsingSerialization.Prototype;

namespace PrototypeUsingSerialization
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Prototype design pattern using serialization example");
